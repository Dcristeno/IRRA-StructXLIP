...
def get_args_multi_vector():
    parser = argparse.ArgumentParser(description="IRRA Multi-Vector Args")
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument("--name", default="multi-vector-li", help="experiment name to save")
    ...
    parser.add_argument("--num_local_vectors", type=int, default=8)
    parser.add_argument("--multi_vector_heads", type=int, default=8)
    parser.add_argument("--eval_global_score_weight", type=float, default=0.3)
    parser.add_argument("--eval_local_score_weight", type=float, default=1.0)
