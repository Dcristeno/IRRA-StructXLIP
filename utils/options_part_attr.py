...
def get_args_part_attr():
    parser = argparse.ArgumentParser(description="IRRA Part Attribute Align Args")
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument("--name", default="part-attr-align", help="experiment name to save")
    ...
    parser.add_argument("--part_loss_weight", type=float, default=0.2)
    parser.add_argument("--part_window_size", type=int, default=3)
    parser.add_argument("--part_upper_ratio", type=float, default=0.45)
    parser.add_argument("--part_lower_ratio", type=float, default=0.80)
    parser.add_argument("--part_attr_lexicon_file", default="misc/part_attr_lexicon.yaml")

    parser.add_argument("--use_swanlab", default=False, action="store_true")
    parser.add_argument("--swanlab_project", default="IRRA-PartAttr")
    ...
    parser.add_argument("--swanlab_tags", nargs="*", default=["irra", "part-attr"])
