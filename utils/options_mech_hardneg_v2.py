...
def get_args_mech_hardneg_v2():
    parser = argparse.ArgumentParser(description="IRRA Phrase-Aware Mechanism-Guided Hard Negative Args")
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument("--name", default="mech-hardneg-v2", help="experiment name to save")
    ...
    parser.add_argument("--dehn_v2_loss_weight", type=float, default=1.2)
    parser.add_argument("--dehn_v2_rank_loss_weight", type=float, default=1.0)
    parser.add_argument("--dehn_v2_support_loss_weight", type=float, default=0.8)
    parser.add_argument("--dehn_v2_phrase_loss_weight", type=float, default=0.4)
    parser.add_argument("--dehn_v2_margin", type=float, default=0.16)
    parser.add_argument("--dehn_v2_support_margin", type=float, default=0.05)
    parser.add_argument("--dehn_v2_phrase_margin", type=float, default=0.03)
    parser.add_argument("--dehn_v2_neg_score_floor", type=float, default=0.25)
    parser.add_argument("--dehn_v2_score_weight", type=float, default=2.0)
    parser.add_argument("--dehn_v2_support_weight", type=float, default=3.0)
    parser.add_argument("--dehn_v2_phrase_weight", type=float, default=1.5)
    parser.add_argument("--dehn_v2_max_phrases", type=int, default=8)
    parser.add_argument("--dehn_v2_max_modifier_words", type=int, default=3)
    ...
    parser.add_argument("--swanlab_tags", nargs="*", default=["irra", "mech-hardneg-v2"])
