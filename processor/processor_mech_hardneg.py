...
def do_train_mech_hardneg(start_epoch, args, model, train_loader, evaluator, optimizer, scheduler, checkpointer, swanlab_logger=None):
    ...
    meters = {
        ...
        "dehn_loss": AverageMeter(),
        "dehn_rank_term": AverageMeter(),
        "dehn_cov_term": AverageMeter(),
        "dehn_pos_sim": AverageMeter(),
        "dehn_neg_sim": AverageMeter(),
        "dehn_pos_cov": AverageMeter(),
        "dehn_neg_cov": AverageMeter(),
        "dehn_neg_weight": AverageMeter(),
        "dehn_neg_dominance": AverageMeter(),
