...
def do_train_color(start_epoch, args, model, train_loader, evaluator, optimizer, scheduler, checkpointer, swanlab_logger=None):
    ...
    meters = {
        ...
        "img_color_acc": AverageMeter(),
        "txt_color_acc": AverageMeter(),
    }
