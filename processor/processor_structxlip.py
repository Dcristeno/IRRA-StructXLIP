...
def do_train_structxlip(start_epoch, args, model, train_loader, evaluator, optimizer, scheduler, checkpointer, swanlab_logger=None):
    ...
    meters = {
        ...
        "struct_global_loss": AverageMeter(),
        "struct_consistency_loss": AverageMeter(),
        "struct_local_loss": AverageMeter(),
